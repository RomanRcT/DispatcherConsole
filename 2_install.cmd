...
import_uiconfig -u=infodba -p=infodba -g=dba -file=ui_config_awtcdispatcher.xml -action=merge
aws2_install_tilecollections -u=infodba -p=infodba -g=dba -mode=add -file=DispatcherConsole_Tiles_install.xml
REM robocopy "aws2" "%TC_ROOT%\aws2" /E /R:0 /W:0
